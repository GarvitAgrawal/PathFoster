			...
			<div class="container">
				...
				<div class="row">
					...
					<div id="main" class="col-md-9">
						...
						<div class="row">
							<h2>Job Openings</h2>
							<a style="font-size:24px; color:blue" target=”_blank” href="https://www.linkedin.com/jobs/search/?currentJobId=3868406943&f_E=1%2C2&geoId=102713980&keywords=API%20integration%20&location=India&origin=JOB_SEARCH_PAGE_SEARCH_BUTTON&refresh=true " style="text-decoration:none;">LinkedIn</a>
