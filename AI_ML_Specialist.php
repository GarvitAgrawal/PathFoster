				...
				<div class="row">
					...
					<!-- main blog -->
						...
						<div class="blog-post" style= "text-align:justify; ">
						 ...
						 <div class="row">
							<h2>Job Openings</h2>
							<a style="font-size:24px; color:blue" target=”_blank” href="https://www.linkedin.com/jobs/search?keywords=AI%20%26%20ML&location=india&geoId=&trk=public_jobs_jobs-search-bar_search-submit&position=1&pageNum=0" style="text-decoration:none;">LinkedIn</a>
